...
if __name__ == '__main__':
    # 数据准备
    img_path = '../models/test_image.jpg'
    ...
    rknn.load_rknn('../models/best.rknn')
    ...
    # 后处理
    boxes, scores, class_ids = postprocess(resized_img, outputs)

    # Iterate over the selected indices after non-maximum suppression
    for box, score, class_id in zip(boxes, scores, class_ids):
        # Pass ratio and padding to draw_detections
        draw_detections(resized_img, box, score, class_id)


    # 保存结果
    cv2.imwrite('../models/test_image_res.jpg', resized_img)
